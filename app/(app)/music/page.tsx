        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
          {tracks.map((track) => {
            ...
            return (
              ...
              >
                <div className="relative aspect-square bg-[#151515] border border-[#292929] rounded-[18px] overflow-hidden mb-2 group-hover:border-yellow-400/20 transition-colors">
